        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable">
                ...
                <el-table-column prop="SmsContent" align="center" label="短信内容" >
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.ExamineState === 1 ||scope.row.ExamineState === 3 " type="text" class="nowrap" style="width:100%;" @click="handleEditContent(scope.row,1)">{{ scope.row.SmsContent}}</el-button>
                        <el-button v-else type="text" class="nowrap" style="width:100%;" @click="handleEditContent(scope.row,2)">{{ scope.row.SmsContent}}</el-button>
                    </template>
                </el-table-column>
            ...
            <el-dialog :title="`编辑短信内容-${editcForm.SellerName}`" :visible.sync="editcVisible" width="633px">
                <el-form ref="editcForm" :model="editcForm" :rules="editcrules" label-width="120px">
                    ...
                    <el-form-item label="消息内容" prop="templatecontent">
                        <el-input :disabled="editVisibleType != 1" type="textarea" v-model="editcForm.templatecontent"></el-input>
                    </el-form-item>
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button v-if="editVisibleType==1" type="primary" size="medium" class="dialog-certain" @click="saveEdit('editcForm')">确 定</el-button>
                    <el-button v-else type="primary" size="medium" class="dialog-certain" @click="editcVisible = false">关 闭</el-button>
                </span>
            </el-dialog>
        </div>
    </div>
