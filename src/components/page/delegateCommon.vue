    ...
    <div class="container">
      ...
      <el-table :data="tableData" fixed border ref="multipleTable">
        ...
        <el-table-column prop="SellerName" align="center" label="父/母名称">
          <template slot-scope="scope">{{scope.row.FatherName}}/{{scope.row.Mother}}</template>
        </el-table-column>
        ...
        <el-table-column align="center" label="操作" width="230px">
          <template slot-scope="scope">
            <el-button type="text">导出到名单</el-button>
...
<script>
import { getManagerCallCenterDelegateCommonList, delegateExportTag, delegateExportTagModify, deleteManagerCallCenterDelegateCommon } from "api/entrust.js";
export default {
  data() {
    return {
      childrenName: "",
