    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="name" placeholder="请输入模块名称" class="handle-input mr10"></el-input>
                <el-button icon="search" @click="search" style="color:018AD8">搜索</el-button>
                <el-button type="primary" style="float:right" @click="showAddForm">添加模块</el-button>
            </div>
            <el-table :data="tableData" border class="table" ref="multipleTable">
                ...
                <el-table-column label="操作"  width="180" align="center">
                    <template slot-scope="scope">
                      ...
                      <el-button type="text" class="red" icon="el-icon-delete" @click="deleteData(scope.row.Id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-dialog title="添加部门" :visible.sync="addVisible" width="30%">
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="_addModule('addForm')">确 定</el-button>
                </span>
            </el-dialog>
            <!-- 编辑弹出框 -->
            <el-dialog title="编辑部门" :visible.sync="editVisible" width="30%">
...
<script>
    import {getModuleList, addModule, editModule, deleteModule} from 'api/system.js'
    import { setToken, removeToken, setUser, getToken} from 'common/js/auth.js'
    export default {
        name: 'Module',
        data() {
            return {
        ...
        methods: {
            ...
            handleEdit(item){
              ...
              this.editForm.sort = item.OrderIndex
              this.editForm.imageUrl = item.IconUrl
