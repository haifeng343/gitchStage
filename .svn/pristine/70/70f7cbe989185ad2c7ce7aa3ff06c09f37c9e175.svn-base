    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable">
                <el-table-column prop="ParamsName" align="center" label="参数名称">
                </el-table-column>
            ...
            <!-- 新增弹出框 -->
            <el-dialog title="添加参数" :visible.sync="addVisible" width="30%">
            ...
            <!-- 编辑弹出框 -->
            <el-dialog :title="`编辑参数-${editForm.name}`" :visible.sync="editVisible" width="633px">
...
<script>
    import {getSystemPList, addSystemP, editSystemP, deleteSystemP} from 'api/system.js'
        ...
        methods: {
            ...
            saveEdit(formName){
              this.$refs[formName].validate((valid) => {
                if (valid) {
                    const params = {
                      'paramsname': this.editForm.name,
                      'paramsvalue': this.editForm.value,
                      'id': this.Id,
                      'description':this.editForm.desc
                    }
                    editSystemP(params).then(res =>{
                        if(res.Success){
                        this.$message({
                            showClose: true,
                            message: '修改成功',
            ...
            handleEdit(item){
              ...
              this.Id = item.Id
              this.editForm.name = item.ParamsName
              this.editForm.value = item.ParamsValue
            ...
            async getData() {
              const params = {
                ...
                'paramsname': this.name
              }
            await  getSystemPList(params).then(res =>{
