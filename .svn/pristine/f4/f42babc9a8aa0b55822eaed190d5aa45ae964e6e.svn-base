    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable">
                ...
                <el-table-column prop="GoodsBasicMoney" align="center" label="充值金额(分)">
                </el-table-column>
                <el-table-column prop="FreeBasicMoney" align="center" label="充值赠送金额(分)">
                </el-table-column>
            ...
            <!--退款弹出框 -->
            <el-dialog :title="`退款信息-${aayAccountName}`" :visible.sync="addVisible" width="30%">
                <el-form ref="addForm" :model="addForm" :rules="addrules" label-width="100px">
                    ...
                    <el-form-item label="退款原因:" prop="refundReason">
                        <el-input v-model="addForm.refundReason"></el-input>
                    </el-form-item>
                </el-form>
            ...
            <el-dialog :title="`退款详情-${aayAccountName}`" :visible.sync="editVisible" width="633px">
                <el-form ref="editForm" :model="editForm"  label-width="120px">
                    <el-form-item label="退款金额(元):">
                        <el-input v-model="editForm.refundmoney" disabled></el-input>
                    </el-form-item>
